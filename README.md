...
<table>
  <tr>
    ...
    <td width="33%">
      ...
      <p align="center">
        <a href="https://github.com/444notdotun/shopco">
      ...
      <p align="center">
        ...
        <a href="https://shopco.vercel.app">
    ...
    <td width="33%">
      ...
      <p align="center">
        <a href="https://github.com/444notdotun/getpaid">
          <img src="https://via.placeholder.com/400x200/092E20/ffffff?text=getPaid" alt="getPaid" width="100%"/>
        </a>
      </p>
      <p>A Django REST API for payments and invoicing. Supports email notifications, MySQL persistence, webhook handling, and environment-based configuration via <code>python-dotenv</code>.</p>
      <p>
...
2. Readable code > clever code. The next person reading it might be you.
3. Tests aren't optional — they're the spec.
4. Ship small, iterate fast, learn constantly.
5. Great software is 20% code, 80% decisions.
```
...
I'm always open to interesting conversations, collaborations, or just talking tech. Reach out — I don't bite.
